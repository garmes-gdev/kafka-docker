...
./connect_config_generator.sh | tee $CUSTOM_CONFIG/connect.properties 
echo ""
...
exec /usr/bin/tini -w -e 143 -- "${KAFKA_HOME}/bin/connect-distributed.sh" $CUSTOM_CONFIG/connect.properties
